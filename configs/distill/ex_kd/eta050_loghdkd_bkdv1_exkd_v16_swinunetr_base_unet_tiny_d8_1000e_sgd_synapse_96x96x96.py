...
model = dict(
    ...
    distiller=dict(
        ...
        teacher_recorders=dict(
            up2=dict(type=ModuleOutputsRecorder, source='segmentor.backbone.decoder1.conv_block'),
            up_ru2=dict(type=ModuleOutputsRecorder, source='segmentor.backbone.decoder1.conv_block.norm2'),
            logits=dict(type=ModuleOutputsRecorder, source='segmentor')
        ),
...
default_hooks['checkpoint'].update(
    dict(save_best=['Dice', 'HD95'], rule=['greater', 'less']))
