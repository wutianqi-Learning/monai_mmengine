...
model = dict(
    ...
    distiller=dict(
        ...
        #     down_conv1=dict(type=R2AModule, student_channels=32, spatial_dims=3),
        #     down_conv2=dict(type=R2AModule, student_channels=64, spatial_dims=3),
        #     down_conv3=dict(type=R2AModule, student_channels=128, spatial_dims=3),
        #     bottom_conv=dict(type=R2AModule, student_channels=256, spatial_dims=3),
        #     up_conv1=dict(type=R2AModule, student_channels=64, spatial_dims=3),
        #     up_conv2=dict(type=R2AModule, student_channels=32, spatial_dims=3),
        #     up_conv3=dict(type=R2AModule, student_channels=14, spatial_dims=3),
        # ),
        ...
        teacher_recorders=dict(
            ...
            down_ru2=dict(type=ModuleOutputsRecorder, source='segmentor.backbone.down_layer2.residual'),
            ...
            bottom_ru=dict(type=ModuleOutputsRecorder, source='segmentor.backbone.bottom_layer.residual'),
            ...
            up_ru2=dict(type=ModuleOutputsRecorder, source='segmentor.backbone.up_layer2.1.residual'),
