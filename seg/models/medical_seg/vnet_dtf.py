...
class OutputTransition(nn.Module):
    def __init__(
        ...
        self.conv2_tanh = conv_type(out_channels, out_channels, kernel_size=1)
        # self.conv_dis_1 = conv_type(1, 1, kernel_size=1)
        # self.conv_dis_2 = conv_type(1, 1, kernel_size=1)
        # self.conv_dis_3 = conv_type(1, 1, kernel_size=1)
        # self.conv_dis_4 = conv_type(1, 1, kernel_size=1)
        # self.conv_dis_5 = conv_type(1, 1, kernel_size=1)
        # self.conv_dis_6 = conv_type(1, 1, kernel_size=1)
        # self.conv_dis_7 = conv_type(1, 1, kernel_size=1)
        # self.conv_dis_8 = conv_type(1, 1, kernel_size=1)
        # self.conv_dis_9 = conv_type(1, 1, kernel_size=1)
        # self.conv_dis_10 = conv_type(1, 1, kernel_size=1)
        # self.conv_dis_11 = conv_type(1, 1, kernel_size=1)
        # self.conv_dis_12 = conv_type(1, 1, kernel_size=1)
        # self.conv_dis_13 = conv_type(1, 1, kernel_size=1)
        # self.conv_dis_14 = conv_type(1, 1, kernel_size=1)
    ...
    def forward(self, x):
        ...
        # dis_2 = self.conv_dis_2(out[:,1:2,...])
        # dis_3 = self.conv_dis_3(out[:,2:3,...])
        # dis_4 = self.conv_dis_4(out[:,3:4,...])
        # dis_5 = self.conv_dis_5(out[:,4:5,...])
        # dis_6 = self.conv_dis_6(out[:,5:6,...])
        # dis_7 = self.conv_dis_7(out[:,6:7,...])
        # dis_8 = self.conv_dis_8(out[:,7:8,...])
        # dis_9 = self.conv_dis_9(out[:,8:9,...])
        # dis_10 = self.conv_dis_10(out[:,9:10,...])
        # dis_11 = self.conv_dis_11(out[:,10:11,...])
        # dis_12 = self.conv_dis_12(out[:,11:12,...])
        # dis_13 = self.conv_dis_13(out[:,12:13,...])
        # dis_14 = self.conv_dis_14(out[:,13:14,...])
        # diss = torch.cat([dis_1, dis_2, dis_3, dis_4,dis_5,dis_6,dis_7,dis_8,dis_9,dis_10,dis_11,dis_12,dis_13,dis_14], dim=1)
        diss = self.conv2_tanh(out)
        dis_tanh = self.tanh(diss)
        out = self.conv2(out)
        return dis_tanh, out
