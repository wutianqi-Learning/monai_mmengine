...
def register_all_modules(init_default_scope: bool = True) -> None:
    ...
    import seg.datasets  # noqa: F401,F403
    import seg.engine  # noqa: F401,F403
    import seg.evaluation  # noqa: F401,F403
    import seg.models  # noqa: F401,F403

    if init_default_scope:
        never_created = DefaultScope.get_current_instance() is None \
                        or not DefaultScope.check_instance_created('seg')
        if never_created:
            DefaultScope.get_instance('seg', scope_name='seg')
            return
        current_scope = DefaultScope.get_current_instance()
        if current_scope.scope_name != 'seg':
            ...
            DefaultScope.get_instance(new_instance_name, scope_name='seg')
