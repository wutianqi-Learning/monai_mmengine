...
def cal_train_time(log_dicts, args, json_logs):
...
WORK_DIRS = [
    'vis_ckpts/unet_r18v1c_d8_40k_synapse/scalars.json',
    'vis_ckpts/unet_r18v1c_se_40k_synapse/scalars.json',
    'vis_ckpts/unet_r18v1c_cbam_40k_synapse/scalars.json',
    'vis_ckpts/unet_r18v1c_psa_s_40k_synapse/scalars.json',
    'vis_ckpts/unet_r18v1c_ccnet_40k_synapse/scalars.json',
    'vis_ckpts/unet_r18v1c_gcb_40k_synapse/scalars.json',
    'vis_ckpts/unet_r18v1c_hamnet_40k_synapse/scalars.json',
    'vis_ckpts/unet_r18v1c_dsnet_v14_40k_synapse/scalars.json',
    'work_dirs/attn_ma_unet_r18v1c_synapse_40k/5-run_20231013_165701/run0/20231013_165701/vis_data/scalars.json',
    'vis_ckpts/mednext_40k_synapse/scalars.json',
    'vis_ckpts/missformer_40k_synapse/scalars.json',
    'vis_ckpts/swin_unetr_base_40k_synapse/scalars.json',
    # 'vis_ckpts/transunet.json',
    'vis_ckpts/nopretrain_unet_segnext_b_40k_synapse/log.json',
    'vis_ckpts/unet_r18v1c_dsnet_v14_dam_40k_synapse/scalars.json',
    'vis_ckpts/nopretrained_unet_conv_next_b_synapse_40k/scalars.json'
]

def main():
    args = parse_args()
    for json in WORK_DIRS:
        args.json = [json]
        json_logs = args.json
        ...
        if args.task == 'cal_train_time':
            cal_train_time(log_dicts, args, json_logs)
